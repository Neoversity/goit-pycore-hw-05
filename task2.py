...
def generator_numbers(text: str) -> str:
    ...
    numbers = re.findall(r'\b\d+\.\d+\b', text) # всі дійсні числа
    for number in numbers:
        yield float(number) # генератор

def sum_profit(text: str, func: Callable) -> float:
    
    numbers_generator = func(text)  # Використовуємо передану функцію-генератор для отримання чисел    
    total = sum(numbers_generator) # Підсумовуємо всі числа
    return total
